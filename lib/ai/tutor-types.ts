...
export const TUTOR_ACTIONS = ['teach', 'hint', 'practice', 'quiz', 'feedback', 'flashcards', 'graph', 'assignment-plan', 'assignment-review', 'study-coach', 'writing-suggestions', 'notes', 'draft'] as const
